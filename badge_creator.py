...
def check_badge(badge_url):
    ...
    return source.status_code is requests.codes.ok


def create_badges(badge_data: dict, template_path) -> None:
    """
    Generate a Markdown file with badges based on the given data.
    ...
    with open(template_path, "w") as f:
        f.write("<p>\n")
        badge_link = f"  <!-- Badges Link https://github.com/alexandresanlim/Badges4-README.md-Profile -->\n"
        f.write(badge_link)
...
if __name__ == "__main__":
    ...
    create_badges(badges, "templates/badges.md")
